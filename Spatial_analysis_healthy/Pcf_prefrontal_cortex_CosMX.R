...
sce$Location_Center_X = Raw_metadata$cell_centroid_x/10
sce$Location_Center_Y = Raw_metadata$cell_centroid_y/10
sce$ImageNumber =  1
...
List_coef = c()
par(las=1,bty='l')
plot(Results_sigmoid$tau,colMeans(Sampling_500µm[[1]],na.rm = T),xlim=c(0,2000),ylim=c(0,2000),xaxs='i',yaxs='i',pch=21,bg="red3",cex=2,cex.lab=1.3,xlab="Tau parameter values (µm)",ylab="Mean estimated tau values (µm)",main="500µm FoV")
...
plot(Results_sigmoid$tau,colMeans(Sampling_1000µm[[1]],na.rm = T),xlim=c(0,2000),ylim=c(0,2000),xaxs='i',yaxs='i',pch=21,bg="red3",cex=2,cex.lab=1.3,xlab="Tau parameter values (µm)",ylab="Mean estimated tau values (µm)",main="1000µm FoV")
abline(0,1,lwd=2,lty=2,col="grey")
m = lm(colMeans(Sampling_1000µm[[1]],na.rm = T)~0+Results_sigmoid$tau)
abline(0,coef(m),lwd=2,lty=2,col="black")
List_coef = c(List_coef,coef(m))

plot(Results_sigmoid$tau,colMeans(Sampling_1500µm[[1]],na.rm = T),xlim=c(0,2000),ylim=c(0,2000),xaxs='i',yaxs='i',pch=21,bg="red3",cex=2,cex.lab=1.3,xlab="Tau parameter values (µm)",ylab="Mean estimated tau values (µm)",main="1500µm FoV")
abline(0,1,lwd=2,lty=2,col="grey")
m = lm(colMeans(Sampling_1500µm[[1]],na.rm = T)~0+Results_sigmoid$tau)
abline(0,coef(m),lwd=2,lty=2,col="black")
List_coef = c(List_coef,coef(m))

plot(Results_sigmoid$tau,colMeans(Sampling_2000µm[[1]],na.rm = T),xlim=c(0,2000),ylim=c(0,2000),xaxs='i',yaxs='i',pch=21,bg="red3",cex=2,cex.lab=1.3,xlab="Tau parameter values (µm)",ylab="Mean estimated tau values (µm)",main="2000µm FoV")
abline(0,1,lwd=2,lty=2,col="grey")
...
boxplot(CV_500µm_p,CV_1000µm_p,CV_1500µm_p,CV_2000µm_p,names = c("500µm","1000µm","1500µm","2000µm"),outline=F,yaxs='i')
